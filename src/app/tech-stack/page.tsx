...
const skillCategories: SkillItem[] = [
    ...
    },
    {
        category: "Systems",
        title: "Microsoft 365",
        description: "Enterprise Microsoft 365 administration & collaboration",
        icon: Mail,
        skills: [
            "Microsoft 365 Administration",
            "Exchange Online (Mailbox/Org Admin)",
            "SharePoint & Teams",
            "Microsoft Defender",
            "Entra ID / Azure AD",
    ...
    },
    {
        ...
        skills: [
            ...
            "MFA / SSO / 2FA",
            "OKTA (SSO/Identity Provisioning)",
            "JAMF Pro (Familiar)",
    ...
    },
    {
        ...
        description: "Server, virtualization, and provisioning foundations",
        icon: Database,
        skills: [
            "Citrix",
            "VMware vSphere (Foundational)",
            "Azure Virtual Desktop / VDI (Foundational)",
            "UPS Monitoring",
            "Zero-Touch Provisioning"
        ]
    },
            ...
            <Section className="!pb-0">
                <div className="flex flex-col items-center text-center gap-6 mb-16 md:mb-24">
                    ...
                    <div className="space-y-4 max-w-3xl">
                        ...
                        >
                            Microsoft 365, Apple & macOS, Google Workspace, enterprise endpoint management, courtroom AV technology, and <span className="text-teal font-medium">AI-assisted workflows</span>.
                        </motion.p>
                    </div>
                </div>
