...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative flex min-h-[85vh] flex-col items-center justify-center overflow-hidden bg-background px-6 py-12 md:py-20">
        ...
        <div className="relative z-10 max-w-6xl w-full mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-24 text-center lg:text-left">
            ...
            <div className="relative flex-shrink-0">
              ...
              />
              <div className="relative h-[110px] w-[110px] md:h-[180px] md:w-[180px] rounded-full p-[1px] bg-surface shadow-xl shadow-navy/10 overflow-hidden border border-border">
                <Image
            ...
            <div className="flex-1 space-y-8 md:space-y-10">
              <div className="flex flex-col items-center lg:items-start gap-4 md:gap-6">
                <span className="rounded-full border border-border bg-surface/80 px-4 py-1.5 text-[0.75rem] md:text-[0.8125rem] font-semibold uppercase tracking-[0.2em] text-steel backdrop-blur-sm shadow-sm">
                  Senior IT Systems Support
                </span>
                <h1 className="text-3xl md:text-[3.25rem] font-bold tracking-tight text-foreground leading-tight md:leading-[1.2]">
                ...
                <p className="max-w-2xl text-[1rem] md:text-[1.125rem] font-normal leading-relaxed text-text-secondary text-balance">
                  Expert systems administration and infrastructure support for government and enterprise environments.
                </p>
              </div>

              <div className="flex flex-col gap-4 sm:flex-row justify-center lg:justify-start pt-2 w-full sm:w-auto">
                <Link
                  href="/experience"
